                        ...
                        <Row className="justify-content-center  py-5">
                            <Col lg="7">
                                <form onSubmit={submit}>
                                    <div class="mb-3 pt-3">
                                        <label class="form-label" style={{ fontSize: "28px", fontWeight: "500" }}>Create Your account</label><br />
                                        <label class="form-label pt-1" style={{ fontWeight:"380", fontSize:"smaller"}}>Sign up below to create your account</label><br />
