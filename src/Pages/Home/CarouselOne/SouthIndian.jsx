                ...
                <Container className="px-0">
                    <Row className=" pt-5">
                        <Col lg="12">
                            <div>
                                <div>
                                    <h2 style={{ fontSize:"45px", fontWeight:"bold"}}>South Indian</h2>
                                    <p style={{ fontSize:"18px", fontWeight:"490"}}>Explore hot & spicy dishes that are a specialty of South India.</p>
                                </div>
                            </div>
                        </Col>
                    </Row>
