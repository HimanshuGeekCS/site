                ...
                <Container className="px-0">
                    <Row className=" pt-5">
                        <Col lg="12">
                            <div>
                                <div>
                                    <h2 style={{ fontSize:"45px", fontWeight:"bold"}}>Chole Bhature</h2>
                                    <p style={{ fontSize:"18px", fontWeight:"490"}}>Satisfy your cravings with these fluffy & flavoursome breads paired with Chole.</p>
                                </div>
                            </div>
                        </Col>
                    </Row>
