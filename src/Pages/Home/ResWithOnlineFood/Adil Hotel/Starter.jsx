...
import { AllStarters } from "./MenuAdilHotal"
...
export const Starter = () => {
    ...
    const [Starters, SetStarters] = useState(AllStarters)

    // it store data in cartdata when user Click on add button or if not they store an empty Array in cartdata(State).
                            ...
                            <Accordion className=" accordion-flush" defaultActiveKey="0" >
                                <Accordion.Item eventKey="0">
                                    <Accordion.Header className=" accordion-flush">
                                        <p className=" fw-bolder"> Starters (North Indian) (6)</p></Accordion.Header>
