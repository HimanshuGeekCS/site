...
import { AllEggMainCourse } from "../MenuAdilHotal";


export const EggMainCourse = () => {

    const [EggMainCourse, SetEggMainCourse] = useState(AllEggMainCourse);
    ...
    useEffect(() => {
        const update = EggMainCourse.map((e) => {
