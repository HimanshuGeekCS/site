...
export const Best_Restaurants_City = () => {
    ...
    const [Data, SetData] = useState([
        {
            ...
            price: 300, Booktable: "yes", Quantity: 1, location: "Bangalore",
        },
        {
            ...
            price: 400, Booktable: "no", ServesAlcohol: "yes", Quantity: 1, location: "Bangalore",
        },
        {
            ...
            price: 300, Booktable: "no", ServesAlcohol: "yes", Quantity: 1, location: "Bangalore",
        },
        {
            ...
            price: 1300, Booktable: "no", ServesAlcohol: "yes", Quantity: 1, location: "Pune",
        },
        {
            ...
            price: 500, Booktable: "yes", Quantity: 1, location: "Pune",
        },
        {
            ...
            price: 500, Booktable: "no", ServesAlcohol: "yes", Quantity: 1, location: "Mumbai",
        },
        {
        ...
        },
        {
            ...
            price: 700, Booktable: "no", ServesAlcohol: "yes", Quantity: 1, location: "Delhi",
        },
        {
            ...
            distance: 2.2 + "km", discount: "Flat 15% off on pre-booking", Dish: "veg", link: "/AdilHotel",
            price: 700, Booktable: "yes", Quantity: 1, location: "Delhi",
        },
        {
            ...
            price: 700, Booktable: "yes", Quantity: 1, location: "Hyderabad",
        },
        {
        ...
        },
        {
            ...
            price: 700, Quantity: 1, location: "Kolkata",
        },
        {
            ...
            price: 600, Booktable: "yes", Quantity: 1, location: "Kolkata",
        },
        {
    ...
    // useLocation() is to use access state data.
    // location.state access that sate form other Component and show the data.
            ...
            <Container fluid className="">
                <Container className="">
                    <Row className="pt-5 px-5">
                        <Col lg="12" >
                            <div>
                                <img src="https://media-assets.swiggy.com/swiggy/image/upload/fl_lossy,f_auto,q_auto/portal/m/seo/DO_collectionBanner.png" alt="" className="img-fluid rounded-5 object-fit-cover position-relative" style={{ height: "340px", width: "100%" }} />
                            </div>
                            <div className=" position-absolute  text-white px-2" style={{ top: "310px" }}  >
                                <h1 className="text-center fs-2">Best restaurants in {a.location}</h1>
                            </div>
                        </Col>
                    </Row>

                    <Row className="py-5 mb-5 pb-5 px-5 ">
                        <Col lg="12">
